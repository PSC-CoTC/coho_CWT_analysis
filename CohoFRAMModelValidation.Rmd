...
Model used by the Pacific Salmon Commission[^1], Pacific Fishery Management Council, Washington Department of Fish and Wildlife, and Puget Sound Treaty Tribes to evaluate the effects of fisheries on Chinook and Coho salmon.
...
Main computer program used to build the current Coho base period from 1986-1992 coded-wire-tags, resulting in the base period exploitation rates utilized in [FRAM](#FRAM) runs.
...
<a id='PST'></a>**Pacific Salmon Treaty**<br> [(PST):](https://www.psc.org/about-us/history-purpose/pacific-salmon-treaty/) 
Treaty between the Governments of Canada and the United States of America concerning Pacific Salmon.

<a id='RMIS'></a>**Regional Mark Information System (RMIS)** <>
...
For many fisheries, agreement between FRAM mark rates and sampling mark rates is moderate or poor. Although when aggregating over fisheries and years within large geographic areas, mark rate differences can be quite small.
...
**Updating the Mixed Stock Model**
...
To nevertheless deliver a product helpful for future base period development and updates, the following products were developed:
1. A description of challenges to updating the base period and where possible potential solutions.
2. Development of Mixed Stock Model documentation
4. Updated instructions to map RMIS recoveries to FRAM fisheries



### Sensitivity Analysis

### Mixed Stock Model Updating
