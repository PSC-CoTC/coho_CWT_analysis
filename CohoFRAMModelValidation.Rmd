...
Examples of unmodeled fisheries are some Columbia River fisheries that are accounted for in regional models rather than in FRAM or some South of Falcon fisheries that report a small amount of likely
illegal catch. 
...
This coefficient is referred to as an "Expansion" in Appendix table 9.3. The coefficient is computed by summing the reported RMIS catch over all the strata within a year divided by the sum of the RMIS catch associated with a sampling event.
