...
<!-- Add a focal stock table containing the number of CWT recoveries in mixed stock fisheries and escapements here!!! 
...
er_fram_rmis |> 
  ...
  filter(
    run_year != 2015,
    StockID %in% c(20, 38, 48, 58, 68, 96, 134, 142, 148, 152, 164, 166, 176, 226, 230)
    ) |> 
  group_by(sidnm) |> 
