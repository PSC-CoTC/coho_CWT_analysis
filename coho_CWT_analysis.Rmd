...
lu <- list(
  ...
  ,
  #AHB file...
  ahb_fishmap = readr::read_csv("T:/DFW-Salmon Mgmt Modeling Team - General/Southern Fund Projects/Coho FRAM MSM CWT analysis/FishMapJun29_2022.csv") |> 
...
fram_fishery_fw_spt <- c(
  27,28,29,30,31,46,51,54,58,59,60,61,62,65,66,67,70,73,
  76,89,90,94,95,99,100,108,116,117,127,128,135,149,150,151,
  163,164,165,166,169
  )


#primary dataset, construction below
