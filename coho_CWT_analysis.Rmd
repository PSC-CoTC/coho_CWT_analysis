...
lu <- list(
  ...
  # #orig csv in "T:/DFW-Salmon Mgmt Modeling Team - General/Southern Fund Projects/Coho FRAM MSM CWT analysis/ERAnalysis/FishMap.csv"; several additional csv iterations copied into workbook
