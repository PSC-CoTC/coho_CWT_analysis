...
focal_run_ids <- 34:44 #2010:2020
#Skagit, Sno, Green, Willapa, Columbia Early, Columbia Late, Fraser Lower, Fraser Upper
focal_stock_ids <- c(20, 38, 96, 164, 166, 176, 226, 230) 
fram$escp <- framr::read_coho_escp(fp$mdb_pst, runs = focal_run_ids, stocks = focal_stock_ids)
fram$mort <- framr::read_coho_mort(fp$mdb_pst, runs = focal_run_ids, stocks = focal_stock_ids)
...
#same, showing pattern by key fishery types
er_rmis_focal |> 
  distinct(run_year, StockID, f_type, rmis_er) |> 
  ggplot(aes(run_year, rmis_er, fill = f_type)) + geom_col() + facet_wrap(~StockID, scales = "free")
