...
#even when actual strings in RMIS and LU are less
...
focal_run_ids <- 34:44 #2010:2020
#Skagit, Sno, Nisqually, Green, Quinault, Willapa, Columbia Early, Columbia Late, Fraser Lower, Fraser Upper
focal_stock_ids <- c(20, 38, 68, 96, 148, 164, 166, 176, 226, 230) 
fram$escp <- framr::read_coho_escp(fp$mdb_pst, runs = focal_run_ids, stocks = focal_stock_ids)
fram$mort <- framr::read_coho_mort(fp$mdb_pst, runs = focal_run_ids, stocks = focal_stock_ids)
